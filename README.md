...
If you don't want to use the transmitter/reciever setup, comment out "#define USE_TELE".
If you don't want to use SD cards, comment out "#define USE_SD".
If you don't want to use serial usb output (used mainly for testing), comment out "#define USE_USB".
